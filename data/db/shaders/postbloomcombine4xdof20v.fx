...
/*
  ...
  */
  ...
  for(int i = 0; i < kernel; i++) {
      float2 texelcoord;
      texelcoord.x = In.TexCoord0.x;
      texelcoord.y = In.TexCoord0.y + (i - kernel / 2) * In.TexCoord1.y;
...
technique PostBloomCombine4xDOF20V
<
  string shadername = "PostBloomCombine4xDOF20V";
