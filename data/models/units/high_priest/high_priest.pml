<?xml version="1.0"?>
<library id="HighPriest_physX_only" type="physics">
 <scenedesc source="3dsmax">
  <eye>-4.76261 -10.9155 1.99727</eye>
  <gravity>0.0 0.0 -10.0</gravity>
  <lookat>-4.37308 -9.99784 1.9188</lookat>
  <up>0.0 0.0 1.0</up>
 </scenedesc>
 <physicsmodel id="main">
  ...
  <rigidbody id="Bone33">
   <mass>10.0</mass>
   <orientation>-0.723491 0.0204897 -0.689678 0.0220423</orientation>
   <position>-0.846524 -0.151706 1.15824</position>
   <shape id="shape_Bone33">
    <orientation>0.0 0.0 0.0 1.0</orientation>
    <physicsmaterial id="Bone33_mat">
     <dynamicfriction>0.4</dynamicfriction>
     <restitution>0.25</restitution>
     <staticfriction>0.4</staticfriction>
    </physicsmaterial>
    <geometry id="Bone33_geom">
     <convex facecount="0">
      <vertices count="6">
         -1.29105 0.00935757 -0.00362035,
         0.841706 0.0378162 0.0686199,
         0.8384 -0.0618354 0.0687781,
         0.837515 0.0380692 -0.0907875,
         0.834208 -0.0615824 -0.0906294,
         1.02797 0.017535 -0.00591039,
      </vertices>
     </convex>
    </geometry>
   </shape>
